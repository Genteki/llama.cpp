...
extern "C" {
    ...
    enum llama_ftype {
        ...
        LLAMA_FTYPE_MOSTLY_GENTEKI_Q4_0  = 40, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_GENTEKI_Q3J1  = 41, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_Q3J1_TQ       = 42, // except 1d tensors
