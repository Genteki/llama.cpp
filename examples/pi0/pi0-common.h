...
// PI0 shared code: constants, weight structures, model loading, and inference functions.
// Used by both pi0.cpp (inference) and pi0-bench.cpp (benchmark).
...
inline std::vector<std::vector<float>> g_prefix_k(PI0_N_LAYER);
inline std::vector<std::vector<float>> g_prefix_v(PI0_N_LAYER);
