...
static ggml_type llama_ftype_get_default_type(llama_ftype ftype) {
    switch (ftype) {
        ...
        case LLAMA_FTYPE_MOSTLY_GENTEKI_Q4_0: return GGML_TYPE_GENTEKI_Q4_0;
        case LLAMA_FTYPE_MOSTLY_GENTEKI_Q3J1: return GGML_TYPE_GENTEKI_Q3J1;
        case LLAMA_FTYPE_MOSTLY_Q3J1_TQ:      return GGML_TYPE_Q3J1_TQ;
